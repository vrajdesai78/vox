  ...
  return (
    <div className="container mx-auto max-w-6xl border-x-2 border-black/10 font-bricolage">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {Object.entries(farhat.requests).map(([key, request]) => (
          <div
            key={key}
          ...
          >
            ...
            <div className="">
              ...
              <div className="mt-4 flex space-x-2">
                <button className="bg-gradient-to-b from-[#222222] to-[#111111] text-white px-5 py-1 rounded-lg hover:scale-95 transition-all">
                  Approve selling
                </button>
